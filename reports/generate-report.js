 ...
 *
 * Creates a beautiful, minimal dark-themed HTML report from benchmark data
...
<head>
    ...
    <title>CVM Performance Analysis</title>
...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Startup benchmarks across ${stats.total} Claude Code versions</p>
        </header>
            ...
            <table id="versionsTable">
                <thead>
                    <tr>
                        ...
                        <th onclick="sortTable(1)" style="cursor: pointer;">Startup Time ▼</th>
                        <th onclick="sortTable(2)" style="cursor: pointer;">Runs ▼</th>
                        <th>Status</th>
                    </tr>
                </thead>
                <tbody>
        ...
        <footer>
            ...
            <p style="margin-top: 8px;">Benchmarks measured using <code>claude --version</code> command (full process spawn to exit)</p>
        </footer>
    </div>
